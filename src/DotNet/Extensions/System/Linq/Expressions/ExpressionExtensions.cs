    ...
    public static class ExpressionExtensions
    {
        ...
        public static (Expression propertySelectorExpression, Type targetPropertyType) MakeMemberSelectorExpression<T>(string propertyName)
        {
            ...
            foreach (var route in propertyRoute)
            {
                ...
                {
                    throw Error.Argument(Error.Format(SRResources.PropertyMissing, route, entityType), nameof(propertyInfo));
                }
        ...
        {
            var entityType = typeof(T);
            var memberAccessParameter = Expression.Parameter(entityType);
            ...
            foreach (var route in propertyRoute)
            {
                ...
                {
                    targetPropertyType = entityType;
                    propertySelectorExpression = memberAccessParameter;
                }
                else
                {
                    var type = (targetPropertyType ?? entityType);
